    ...
    <div className="flex flex-col gap-6 flex-1">
      ...
      <div className="flex flex-row justify-between p-10">
        ...
        <div className="flex flex-row gap-8 max-res:gap-">
          <img src={icon1} alt="" className="w-[20%] h-[40%] cursor-pointer max-md:w-[20px] max-md:h-[20px]" />
          <img src={icon2} alt="" className="w-[20%] h-[40%] cursor-pointer max-md:w-[20px] max-md:h-[20px]" />
          <img src={icon3} alt="" className="w-[20%] h-[40%] cursor-pointer max-md:w-[20px] max-md:h-[20px]" />
          <img
            src={icon4}
            alt=""
            className={
              open6
                ? "w-[20%] h-[40%] cursor-pointer max-md:w-[20px] max-md:h-[20px]"
                : "w-[20%] h-[40%] cursor-pointer max-md:w-[20px] max-md:h-[20px] rotate-180"
            }
            onClick={handleCard6}
          />
        </div>
      ...
      <div className=" flex flex-col gap-3 card1 rounded-2xl" data-aos="fade-up">
        <div className="flex flex-row justify-between p-10">
          ...
          <div className="flex flex-row gap-8 max-res:gap-">
          <img src={icon1} alt="" className="w-[100%] h-[80%] cursor-pointer max-md:w-[20px] max-md:h-[20px]" />
            <img src={icon2} alt="" className="w-[100%] h-[80%] cursor-pointer max-md:w-[20px] max-md:h-[20px]" />
            <img src={icon3} alt="" className="w-[100%] h-[80%] cursor-pointer max-md:w-[20px] max-md:h-[20px]" />
            <img src={icon4} alt="" className={open7 ? "w-[100%] h-[80%] cursor-pointer max-md:w-[20px] max-md:h-[20px]" : "w-[100%] h-[80%] cursor-pointer max-md:w-[20px] max-md:h-[20px] rotate-180"} onClick={handleCard7}/>
          </div>
        </div>
