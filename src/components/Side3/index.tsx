    ...
    <div className="flex flex-col gap-6 flex-1 lg:grid max-lg:grid-cols-2 max:lg:w-[100vw]">
      ...
      <div className=" flex flex-col gap-3 card3 rounded-2xl">
        <div className="flex flex-row justify-between px-10 py-5">
          ...
          <div className="flex flex-row gap-5">
          <img src={icon1} alt="" className="w-[100%] h-[80%] cursor-pointer max-md:w-[30px] max-md:h-[20px]" />
            <img src={icon2} alt="" className="w-[100%] h-[80%] cursor-pointer max-md:w-[30px] max-md:h-[20px]" />
            <img src={icon3} alt="" className="w-[100%] h-[80%] cursor-pointer max-md:w-[30px] max-md:h-[20px]" />
            <img src={icon4} alt="" className={open10 ? "w-[100%] h-[80%] cursor-pointer max-md:w-[30px] max-md:h-[20px]" : "w-[100%] h-[80%] max-md:w-[30px] max-md:h-[20px] cursor-pointer rotate-180"} onClick={handleCard10}/>
          </div>
        </div>
      ...
      <div className=" flex flex-col gap-3 card1 rounded-3xl">
        <div className="flex flex-row justify-between px-10 py-7">
          ...
          <img src={icon1} alt="" className="w-[100%] h-[80%] cursor-pointer max-md:w-[30px] max-md:h-[20px]" />
            <img src={icon2} alt="" className="w-[100%] h-[80%] cursor-pointer max-md:w-[30px] max-md:h-[20px]" />
            <img src={icon3} alt="" className="w-[100%] h-[80%] cursor-pointer max-md:w-[30px] max-md:h-[20px]" />
            <img src={icon4} alt="" className={open11 ? "w-[100%] h-[80%] cursor-pointer max-md:w-[30px] max-md:h-[20px]" : "w-[100%] max-md:w-[30px] max-md:h-[20px] h-[80%] cursor-pointer rotate-180"} onClick={handleCard11}/>
          </div>
        </div>
