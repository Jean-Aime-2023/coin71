...
const index = () => {
  ...
  return (
    ...
    <div className="flex flex-col gap-6 flex-1 max-res:text-sm">
      ...
      <div className={open ? "hidden" : " "}>
        <li className="flex flex-row justify-between text-lg">
          <div
            className={
              toggleState === 1
                ? "hover:text-red-500 max-res:text-sm cursor-pointer active-tabs"
                : "hover:text-red-500 max-res:text-sm cursor-pointer"
            }
            onClick={() => toggleTab(1)}
          >
            Shop
