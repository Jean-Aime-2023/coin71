    ...
    <>
      <div className="flex flex-col gap-14 justify-center overflow-x-hidden">
        ...
        <div className="w-[96%] shadow-2xl flex flex-row justify-between p-3 rounded-full fixed top-2 left-3 items-center z-30 bg-white">
          ...
          <div className={!menu?"":"flex"} id="container">
          <div
            id="container"
            className={!closeMenu?"":"fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center z-50"}
          >
            <div className={!closeMenu?"hidden":"block"}>
            <ul
              className= "absolute top-5 left-[50%] bg-gray-100 p-4 rounded-2xl flex flex-col gap-3"
